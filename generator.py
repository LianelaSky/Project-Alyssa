        ...
        try:
            ...
            if "message" in response_json and "content" in response_json["message"]:
                 ...
                 if not response_text:
                     thinking_hint = response_json.get("message", {}).get("thinking") or response_json.get("message", {}).get("reasoning_content")
                     if thinking_hint:
                         logger.warning("Ollama returned empty dialogue content but provided hidden reasoning; treating as empty output.")
                     else:
